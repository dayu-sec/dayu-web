...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Visual Refresh Studio enhances website aesthetics by applying custom visual styles and updating hero images." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Visual Refresh Studio enhances website aesthetics by applying custom visual styles and updating hero images." },
