...
function nodeTone(kind: NodeKind) {
  switch (kind) {
    case "core":
      return "border-primary/60 bg-primary/15 text-foreground shadow-[0_0_24px_oklch(0.80_0.15_212/0.35)]";
    case "hub":
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-12 px-6 pb-24 pt-10 lg:grid-cols-[1fr_1.25fr] lg:gap-16 lg:px-10 lg:pt-16">
          ...
          <div className="animate-[fadeUp_0.7s_ease-out_both]">
            ...
            <div className="mt-8 max-w-2xl">
              <div className="relative rounded-2xl border border-primary/25 bg-card/40 px-5 py-4 backdrop-blur-md shadow-[inset_0_0_0_1px_oklch(1_0_0/0.04),0_0_40px_oklch(0.80_0.15_212/0.18)]">
  ...
  return (
    <section id="system" className="relative z-10 border-t border-white/5">
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
        ...
        {/* Diagram canvas */}
        <div className="relative w-full overflow-hidden rounded-2xl border border-primary/20 bg-card/30 p-4 backdrop-blur-md shadow-[0_0_60px_oklch(0.80_0.15_212/0.12)] sm:p-6">
          {/* faint grid */}
          <div
            aria-hidden
  ...
  return (
    <section id="pain" className="relative z-10 border-t border-white/5">
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
        ...
        <div className="mt-10 rounded-2xl border border-primary/25 bg-card/40 p-6 backdrop-blur-md shadow-[0_0_40px_oklch(0.80_0.15_212/0.12)] lg:p-8">
        ...
        <div className="mt-12 grid gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              {SOLUTIONS.map((s) => (
                <div key={s.t} className="rounded-xl border border-primary/25 bg-primary/[0.06] p-5 backdrop-blur shadow-[0_0_30px_oklch(0.80_0.15_212/0.10)]">
