...
function AboutPage() {
  return (
    <PageShell>
      ...
      >
        <div className="mt-8 rounded-2xl border border-primary/25 bg-primary/[0.06] p-6 backdrop-blur-md shadow-[0_0_40px_oklch(0.74_0.14_222/0.12)]">
      ...
      <section className="relative z-10 border-t border-white/5">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2">
            {DIRECTIONS.map((d) => (
              <div key={d.t} className="rounded-xl border border-primary/25 bg-primary/[0.06] p-6 backdrop-blur shadow-[0_0_30px_oklch(0.74_0.14_222/0.10)]">
